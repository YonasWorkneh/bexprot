...
const USDTSendDialog = ({ open, onOpenChange, wallet, onSuccess }: USDTSendDialogProps) => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: err.message || 'Failed to send USDT',
                variant: 'destructive',
            });
        } finally {
            setLoading(false);
                    ...
                    <div className="space-y-4">
                        ...
                        {amount && !hasEnoughBalance && (
                            <Alert variant="destructive">
                                ...
                                <AlertDescription>
                                    Insufficient balance. You need ${formatUSDT(totalAmount)} (including fees).
                                </AlertDescription>
                            </Alert>
                        )}
